// All 253 countries with dial codes, flag image support, and ISO codes
export const COUNTRIES = [
  ...
  { code: 'GB-ENG', name: 'England', dial: '+44' },
  { code: 'GB-NIR', name: 'Northern Ireland', dial: '+44' },
  { code: 'GB-SCT', name: 'Scotland', dial: '+44' },
  { code: 'GB-WLS', name: 'Wales', dial: '+44' },
  ...
  { code: 'GS', name: 'South Georgia and Sandwich Islands', dial: '+500' },
  ...
  { code: 'UM', name: 'US Minor Outlying Islands', dial: '+1' },
